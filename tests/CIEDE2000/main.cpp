...
int main()
{
    ...
    // G. Sharma, W. Wu, E. N. Dalal. 2005. The CIEDE2000 Color-Difference Formula: Implementation Notes, Supplementary
    // Test Data, and Mathematical Observations, Color Research and Application, vol.30. No.1, pp.21--30, February 2005.
    const Eigen::MatrixXd test_data = (Eigen::MatrixXd(34, 7) << 50.0000,
                                       2.6772,
                                       -79.7751,
                                       50.0000,
                                       0.0000,
